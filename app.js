...
class Bd {
    ...
    pesquisar(despesa) {
        ...
        if(despesa.ano != '') {
            despesasFiltradas = despesasFiltradas.filter(d => d.descricao == despesa.descicao)
        }
...
function carregaListaDespesas(despesas = Array(), filtro = false) {
    ...
    despesas.forEach(function(d) {
        ...
        btn.className = '<i class="fas fa-time"></i>'
...
function pesquisaDespesas() {
    ...
    let despesa = new Despesa(ano, mes, dia, tipo, descicao, valor)
